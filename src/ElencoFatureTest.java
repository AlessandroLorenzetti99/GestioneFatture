...
class ElencoFatureTest {
	...
	public void TestGetElementi()
	{
		...
		Fattura f1 = new Fattura(data,2018,1,"Alessandro Lorenzetti","Descrizione1",1000,'P','P');
		Fattura f2 = new Fattura(data,2018,1,"Alessandro Lorenzetti","Descrizione1",1000,'P','P');
